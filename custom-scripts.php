...
<head>
<title>Custom Scripts - Service Manager</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="custom-scripts.php" class="active"><i class="lnr lnr-pencil"></i> <span>Custom Scripts</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
...
<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Create a custom script</h3>
								</div>
								<div class="panel-body">
									...
									<br>
									<textarea class="form-control" placeholder="Paste the content here" rows="4"></textarea>
									<br>
									<div class="text-center"><a href="#" class="btn btn-primary">Add Custom Script</a></div>
								</div>
							</div>
							<!-- END INPUTS -->
</div>
